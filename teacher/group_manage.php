...
<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="group_manage.php"> 添加小组</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-8" style="line-height: 300%">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input class="form-control" type="text" placeholder="name" name="stu_name">
                        </div>
                        <center><button class="btn btn-success" type="submit">确认添加</button></center>
                        </form>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel-body">
                        <form method="post" action="">
                            <div class="form-group input-group">
                                ...
                                <input class="form-control" type="text" placeholder="name" name="group_name">
                            </div>
                            <div class="form-group input-group">
                                <span class="input-group-addon">小组序号</span>
                                <input class="form-control" type="text" placeholder="id" name="group_id">
                            </div>
                            <center><button class="btn btn-sm" type="submit">确认添加</button></center>
                        </form>
                    </div>
                </div>
            </div>
